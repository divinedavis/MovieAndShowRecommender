...
export const metadata: Metadata = {
  title: "Best Directorial Debut Films - First-Time Directors Who Nailed It",
  description: "Discover the highest-rated debut films from first-time directors. These remarkable directorial debuts prove that sometimes fresh vision creates the best cinema.",
  openGraph: {
    title: "Best Directorial Debut Films - First-Time Directors Who Nailed It",
    description: "The highest-rated films from first-time directors who nailed it on their first try.",
    url: "https://movies.unittap.com/lists/debut-films",
  },
  alternates: { canonical: "https://movies.unittap.com/lists/debut-films" },
};

export default async function DebutFilmsPage() {
  ...
  const jsonLd = {
    ...
    '@type': 'ItemList',
    name: 'Best Directorial Debut Films',
    description: 'Highest-rated films from recent first-time directors.',
  ...
  const articleJsonLd = {
    '@context': 'https://schema.org',
    '@type': 'Article',
    headline: 'Best Directorial Debut Films - First-Time Directors Who Nailed It',
    description: 'A curated list of the highest-rated debut films from first-time directors.',
  ...
  return (
    <main className="min-h-screen bg-gray-50 text-gray-950 p-6 md:p-10">
      ...
      <header className="max-w-5xl mx-auto mb-12">
        ...
        <h1 className="text-4xl md:text-6xl font-black italic uppercase tracking-tighter mb-4">Best Directorial Debut Films</h1>
        <p className="text-xs font-black tracking-widest text-blue-600 uppercase mb-4">First-Time Directors Who Nailed It</p>
        <p className="text-lg text-gray-600 max-w-3xl">There is something extraordinary about a director who gets it right on the very first attempt. These debut films represent the boldest, freshest voices in modern cinema &mdash; filmmakers who arrived fully formed with a stunning first feature.</p>
      </header>
