...
const translations: Record<string, Translations> = {
  ...
  ja: {
    ...
    max: 'マックス',
    viewAll: '+ すべて見る',
    winnersAndNominees: '受賞作とノミネート',
    topMoviesThisMonth: '今月のトップ2026映画',
    mostPopularReleases: 'の人気リリース',
    theAbsoluteBestMovies: '前年の最高傑作',
    trendingShows: 'トレンド番組',
    topBoxOffice: 'の興行収入トップ',
    more: 'もっと見る',
    searchRegion: '地域を検索...',
    allRegions: 'すべての地域',
    backToDiscovery: '← 発見に戻る',
    upcomingReleases: '今後の公開予定',
    bestOf: 'のベスト',
    seoTitle: '映画レコメンダー - 人気の映画と番組 -',
    seoDesc: 'ボックスオフィスのヒット作、NetflixやMaxのストリーミングお気に入り、受賞作をチェック -',
    awardsSeoTitle: '受賞作とノミネート -',
    awardsSeoDesc: '映画賞の受賞作とノミネートの完全リスト -',
    calendarSeoTitle: '公開予定の映画 -',
    calendarSeoDesc: '映画公開日の完全なスケジュール -'
  },
  pt: {
    region: 'Região',
    compare: 'Comparar',
    ...
    max: 'Max',
    viewAll: '+ VER TUDO',
    winnersAndNominees: 'Vencedores e Indicados',
    topMoviesThisMonth: 'Melhores Filmes de 2026 deste',
    mostPopularReleases: 'Lançamentos Mais Populares em',
    theAbsoluteBestMovies: 'Os Melhores Filmes do Ano Anterior',
    trendingShows: 'Séries em Tendência',
    topBoxOffice: 'Top Bilheteria em',
    more: 'Mais',
    searchRegion: 'Buscar região...',
    allRegions: 'Todas as Regiões',
    backToDiscovery: '← VOLTAR À DESCOBERTA',
    upcomingReleases: 'Próximos Lançamentos Cinematográficos',
    bestOf: 'O melhor de',
    seoTitle: 'Recomendador de Filmes - Melhores Filmes e Séries em',
    seoDesc: 'Descubra os sucessos de bilheteria, favoritos de streaming na Netflix e Max, e vencedores de prêmios em',
    awardsSeoTitle: 'Vencedores e Indicados em',
    awardsSeoDesc: 'A lista completa de vencedores e indicados a prêmios de cinema para',
    calendarSeoTitle: 'Filmes que Estreiam em',
    calendarSeoDesc: 'A lista completa de todas as datas de estreia de filmes para'
  }
};
